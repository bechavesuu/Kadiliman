...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
        ...
        <div class="row">
          <!-- Left column: Logo and Inquire button -->
          <div class="col-md-6 text-center d-flex flex-column justify-content-center">
            <img class="img-fluid" src="img/LOGO-removebg-preview.png" style="margin: 0px; transform: scale(1.13); height: 280px; object-fit: contain;">
        ...
        <h1 class="text-center" style="font-size: 30px;transform: translateY(71px);">PC Specifications – Choose Your Setup!</h1>
        <p class="text-center" style="font-size: 12px;transform: translateY(94px);">At <strong>Kadiliman Esports Café</strong>, we offer <strong>high-performance gaming setups</strong> tailored to your needs. <br>Whether you're a casual gamer or a competitive pro, we've got the perfect rig for you!</p>
        <div class="row justify-content-center" style="transform: translateY(118px);">
