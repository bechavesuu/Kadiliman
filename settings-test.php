...
$dbname = "kadiliman";     // Change to your database name
...
if ($result->num_rows > 0) {
    ...
    // Store user data for display in form fields
    $firstname = $user_data['firstname'];
    $lastname = $user_data['lastname'];
    $email = $user_data['email'];
    $username = $user_data['username']; // Assuming you have a username column
} else {
    // If user data can't be found, redirect to login
...
if (isset($_POST['update_personal_info'])) {
    ...
    $update_stmt->bind_param("sssi", $new_firstname, $new_lastname, $new_email, $user_id);
...
if (isset($_POST['update_password'])) {
    ...
    // Note: Adjust this verification based on how you store passwords (hash, etc.)
